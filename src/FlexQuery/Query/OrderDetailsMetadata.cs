...
{
    public static class OrderDetailsMetadata
    {
        ...
        public class OrderDetailsTable
        {
            ...
            public Column OrderDetailID => OrderDetailsMetadata.OrderDetailID.WithAlias(_alias);
            public Column OrderID => OrderDetailsMetadata.OrderID.WithAlias(_alias);
            public Column ProductID => OrderDetailsMetadata.ProductID.WithAlias(_alias);
            public Column Quantity => OrderDetailsMetadata.Quantity.WithAlias(_alias);
        }
    }
}
